  ...
  routes: [
    ...
    // //组别列表
    {
      ...
      children: [
        {
          path: "/groups/list",
          component: () => import(/* webpackChunkName: "client-index" */ "@client/views/groupsList/index"),
          meta: { title: "组别列表", nextRoute: "/groups/list/info" },
        },
        {
          path: "/groups/list/info",
          component: () => import(/* webpackChunkName: "client-index" */ "@client/views/groupsInfo/index"),
          meta: {
            title: "详细内容",
            notOpacity: true,
    ...
    // //团队信息
    {
      ...
      children: [
        {
          path: "/message/all",
          component: () => import(/* webpackChunkName: "client-index" */ "@client/views/infomation/index"),
        },
      ],
    },
    // //团队风采
    {
      ...
      children: [
        {
          path: "/elegant/list",
          component: () => import(/* webpackChunkName: "client-index" */ "@client/views/teamViewList/index"),
          meta: {
            title: "风采列表",
            notOpacity: true,
        ...
        },
        {
          ...
          component: () => import(/* webpackChunkName: "client-index" */ "@client/views/teamViewInfo/index"),
          meta: {
            title: "详细内容",
            notOpacity: true,
    ...
    // //团队项目
    {
      ...
      children: [
        {
          path: "/project/list",
          component: () => import(/* webpackChunkName: "client-index" */ "@client/views/projectsList/index"),
          meta: {
            title: "团队项目",
            notOpacity: true,
        ...
        },
        {
          ...
          component: () => import(/* webpackChunkName: "client-index" */ "@client/views/projectInfo/index"),
          meta: {
            title: "浏览项目",
            notOpacity: true,
    ...
    // //科研视频
    {
      ...
      children: [
        {
          path: "/videos/list",
          component: () => import(/* webpackChunkName: "client-index" */ "@client/views/videosList/index"),
          meta: {
            title: "科研视频",
            notOpacity: true,
          },
        },
        {
          ...
          component: () => import(/* webpackChunkName: "client-index" */ "@client/views/videoInfo/index"),
          meta: {
            title: "浏览视频",
            notOpacity: true,
    ...
    // //团队荣誉
    {
      ...
      children: [
        {
          path: "/honor/all",
          component: () => import(/* webpackChunkName: "client-index" */ "@client/views/teamHonor"),
        },
      ],
    },
  ],
