<template>
  <div class="upload-element" v-loading="loading">
    ...
    >
      ...
      <el-row>
        ...
        <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
          ...
          >
            <el-input
              style="width: 300px"
              v-model="ruleForm.articleAuthor"
              placeholder="输入作者"
              class="manage_input"
            ></el-input>
          </el-form-item>
      ...
      >
        <el-input
          v-model="ruleForm.article_intro"
          :rows="1"
          type="textarea"
        ...
        <transition name="el-zoom-in-center">
          <div class="image-preview" v-show="ruleForm.pre_img">
            <div class="image-preview-wrapper">
              <el-image :src="ruleForm.pre_img" class="image"> </el-image>
              <div class="image-preview-action">
                <i
                  class="el-icon-delete"
                  @click="ruleForm.image = ruleForm.pre_img = ''"
                ></i>
              </div>
            </div>
          </div>
...
import { updateElegant, uploadElegant, reqAllGroups, reqElegantByID } from '@admin/api'
  ...
  data() {
    return {
      ...
      rules: {
        ...
        pre_img: [{ required: true, message: "请上传图片", trigger: "blur" }],
      },
      updateRules: {},
    };
  },
