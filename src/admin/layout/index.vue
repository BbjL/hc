<template>
  <el-container
    style="height: 100%; border-right: 1px solid #eee; border-left: 0"
  >
...
import Bread from "@admin/components/Bread/Bread";
...
.content-right .content-header .tit {
  font-family: TencentSansw7;
  color: #333;
}
.content-right .content-header .slide-toggle {
