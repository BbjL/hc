<template>
  <div class="sticky-wrapper" :class="[{notOpacity:$route.meta.notOpacity},{isSticky:isSticky}]"  >
...
export default {
  ...
  mounted(){
    this.$store.dispatch('setSliderRoutes')
    this.sliderRoutes = this.$store.state.sliderRoutes
